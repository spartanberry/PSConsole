...
Invoke-Graph '/deviceManagement/windowsAutopilotDeviceIdentities' |
Where-Object { -not $UnassignedOnly -or $_.deploymentProfileAssignmentStatus -notlike 'assigned*' } |
ForEach-Object {
    [PSCustomObject]@{
        ...
        ProfileStatus   = $_.deploymentProfileAssignmentStatus
        LastContacted   = $_.lastContactedDateTime
    }
} | Sort-Object ProfileStatus, Serial
