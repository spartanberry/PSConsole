...
@{
    ...
    Copyright         = 'Copyright (c) 2017-2026 Matthew Kelly (Badgerati), licensed under the MIT License.'
    ...
    PrivateData       = @{
        PSData       = @{
            ...
            ReleaseNotes = 'https://github.com/Badgerati/Pode/releases/tag/v2.13.4'
        }
        PwshVersions = @{
            Untested  = '7.3,7.2,7.1,7.0,6.2,6.1,6.0,5.0,4.0,3.0,2.0,1.0'
            Supported = '7.6,7.5,7.4,5.1'
        }
    }
}
